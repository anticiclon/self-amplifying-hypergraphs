...
def histogram(alphas, histogramfile):
    """
    Plot a histogram of MAFs for autocatalytic cores.
    
    Parameters:
    - alphas (array-like): List or array of MAF values to plot.
    ...
    plt.hist(alphas, bins=10, color='cornflowerblue', edgecolor='black')
    
    # Add titles and labels
    plt.title("Distribution of MAFs for Autocatalytic Cores", 
              fontsize=38)
    plt.xlabel("MAF", 
               fontsize=36)
